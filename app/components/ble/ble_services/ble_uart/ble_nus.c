...
#define BLE_UUID_NUS_TX_CHARACTERISTIC 0x1702                      /**< The UUID of the TX Characteristic. */
#define BLE_UUID_NUS_RX_CHARACTERISTIC 0x1703                      /**< The UUID of the RX Characteristic. */

#define BLE_NUS_MAX_RX_CHAR_LEN        BLE_NUS_MAX_DATA_LEN        /**< Maximum length of the RX Characteristic (in bytes). */
#define BLE_NUS_MAX_TX_CHAR_LEN        BLE_NUS_MAX_DATA_LEN        /**< Maximum length of the TX Characteristic (in bytes). */

#define NUS_BASE_UUID 					{{0xDB,0x45,0x5A,0xAF,0x93,0xE0,0xDA,0xBC,0xC6,0x40,0x00,0xAF,0x00,0x00,0x1A,0xDA}}

nus_callbacks_t * m_nus_callbacks = NULL;
void register_nus_callbacks(nus_callbacks_t *callbacks)
{
    m_nus_callbacks = callbacks;
}
...
static void on_tx_complete(ble_nus_t * p_nus, ble_evt_t * p_ble_evt)
{
    ...
    if(m_nus_callbacks != NULL) {
        m_nus_callbacks->on_tx_complete_cb(p_nus,p_ble_evt);
    }
