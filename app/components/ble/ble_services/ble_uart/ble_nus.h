...
#define BLE_UUID_NUS_SERVICE 0x1701                      /**< The UUID of the Nordic UART Service. */
...
typedef void (*nus_callback_t)(ble_nus_t * p_nus, ble_evt_t * p_ble_evt);

typedef struct{
    nus_callback_t on_connect_cb;
    nus_callback_t on_disconnect_cb;
    nus_callback_t on_tx_complete_cb;
}nus_callbacks_t;
