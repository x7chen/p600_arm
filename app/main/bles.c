...
#define DEVICE_NAME                 "P600"                                    /**< Name of device used for advertising. */
#define MANUFACTURER_NAME           "C.F.T."                                    /**< Manufacturer. Will be passed to Device Information Service. */
#define MODEL_NUM                   "P600"
#define SERIAL_NUM                  "12345678"
#define HW_REV                      "V0.1"
#define FW_REV                      "V0.1"
#define SW_REV                      "V0.1"
 ...
 */
static const char m_target_periph_name[] = "GLAREME";
...
static void on_ble_peripheral_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
			...
			connect_state = 1;
			ble_connection_send();
			ble_connection(&connect_state,1);
            break; //BLE_GAP_EVT_CONNECTED
...
static void ble_dis_service_init()
{
    ...
    ble_srv_ascii_to_utf8(&dis_init.sw_rev_str, (char *)compile_time);
...
static void ble_dfu_service_init()
{
	uint32_t        err_code;   
	ble_dfu_init_t  dfus_init;	
	memset(&dfus_init, 0, sizeof(dfus_init));
    dfus_init.evt_handler                               = NULL;
...
static void ble_nus_service_init()
{
    ...
    nus_init.data_handler = nus_receive;
